...
import org.jruby.parser.BeaverTokens;
 ...
 */
public class RubyYaccBeaverLexer {
    ...
    public enum Keyword {
        END ("end", BeaverTokens.kEND, BeaverTokens.kEND, LexState.EXPR_END),
        ELSE ("else", BeaverTokens.kELSE, BeaverTokens.kELSE, LexState.EXPR_BEG),
        CASE ("case", BeaverTokens.kCASE, BeaverTokens.kCASE, LexState.EXPR_BEG),
        ENSURE ("ensure", BeaverTokens.kENSURE, BeaverTokens.kENSURE, LexState.EXPR_BEG),
        MODULE ("module", BeaverTokens.kMODULE, BeaverTokens.kMODULE, LexState.EXPR_BEG),
        ELSIF ("elsif", BeaverTokens.kELSIF, BeaverTokens.kELSIF, LexState.EXPR_BEG),
        DEF ("def", BeaverTokens.kDEF, BeaverTokens.kDEF, LexState.EXPR_FNAME),
        RESCUE ("rescue", BeaverTokens.kRESCUE, BeaverTokens.kRESCUE_MOD, LexState.EXPR_MID),
        NOT ("not", BeaverTokens.kNOT, BeaverTokens.kNOT, LexState.EXPR_BEG),
        THEN ("then", BeaverTokens.kTHEN, BeaverTokens.kTHEN, LexState.EXPR_BEG),
        YIELD ("yield", BeaverTokens.kYIELD, BeaverTokens.kYIELD, LexState.EXPR_ARG),
        FOR ("for", BeaverTokens.kFOR, BeaverTokens.kFOR, LexState.EXPR_BEG),
        SELF ("self", BeaverTokens.kSELF, BeaverTokens.kSELF, LexState.EXPR_END),
        FALSE ("false", BeaverTokens.kFALSE, BeaverTokens.kFALSE, LexState.EXPR_END),
        RETRY ("retry", BeaverTokens.kRETRY, BeaverTokens.kRETRY, LexState.EXPR_END),
        RETURN ("return", BeaverTokens.kRETURN, BeaverTokens.kRETURN, LexState.EXPR_MID),
        TRUE ("true", BeaverTokens.kTRUE, BeaverTokens.kTRUE, LexState.EXPR_END),
        IF ("if", BeaverTokens.kIF, BeaverTokens.kIF_MOD, LexState.EXPR_BEG),
        DEFINED_P ("defined?", BeaverTokens.kDEFINED, BeaverTokens.kDEFINED, LexState.EXPR_ARG),
        SUPER ("super", BeaverTokens.kSUPER, BeaverTokens.kSUPER, LexState.EXPR_ARG),
        UNDEF ("undef", BeaverTokens.kUNDEF, BeaverTokens.kUNDEF, LexState.EXPR_FNAME),
        BREAK ("break", BeaverTokens.kBREAK, BeaverTokens.kBREAK, LexState.EXPR_MID),
        IN ("in", BeaverTokens.kIN, BeaverTokens.kIN, LexState.EXPR_BEG),
        DO ("do", BeaverTokens.kDO, BeaverTokens.kDO, LexState.EXPR_BEG),
        NIL ("nil", BeaverTokens.kNIL, BeaverTokens.kNIL, LexState.EXPR_END),
        UNTIL ("until", BeaverTokens.kUNTIL, BeaverTokens.kUNTIL_MOD, LexState.EXPR_BEG),
        UNLESS ("unless", BeaverTokens.kUNLESS, BeaverTokens.kUNLESS_MOD, LexState.EXPR_BEG),
        OR ("or", BeaverTokens.kOR, BeaverTokens.kOR, LexState.EXPR_BEG),
        NEXT ("next", BeaverTokens.kNEXT, BeaverTokens.kNEXT, LexState.EXPR_MID),
        WHEN ("when", BeaverTokens.kWHEN, BeaverTokens.kWHEN, LexState.EXPR_BEG),
        REDO ("redo", BeaverTokens.kREDO, BeaverTokens.kREDO, LexState.EXPR_END),
        AND ("and", BeaverTokens.kAND, BeaverTokens.kAND, LexState.EXPR_BEG),
        BEGIN ("begin", BeaverTokens.kBEGIN, BeaverTokens.kBEGIN, LexState.EXPR_BEG),
        __LINE__ ("__LINE__", BeaverTokens.k__LINE__, BeaverTokens.k__LINE__, LexState.EXPR_END),
        CLASS ("class", BeaverTokens.kCLASS, BeaverTokens.kCLASS, LexState.EXPR_CLASS),
        __FILE__("__FILE__", BeaverTokens.k__FILE__, BeaverTokens.k__FILE__, LexState.EXPR_END),
        LEND ("END", BeaverTokens.klEND, BeaverTokens.klEND, LexState.EXPR_END),
        LBEGIN ("BEGIN", BeaverTokens.klBEGIN, BeaverTokens.klBEGIN, LexState.EXPR_END),
        WHILE ("while", BeaverTokens.kWHILE, BeaverTokens.kWHILE_MOD, LexState.EXPR_BEG),
        ALIAS ("alias", BeaverTokens.kALIAS, BeaverTokens.kALIAS, LexState.EXPR_FNAME),
        __ENCODING__("__ENCODING__", BeaverTokens.k__ENCODING__, BeaverTokens.k__ENCODING__, LexState.EXPR_END);
    ...
    public RubyYaccBeaverLexer() {
    	this(true);
    }
    
    public RubyYaccBeaverLexer(boolean isOneEight) {
    	reset();
...
//        printState();
    ...
    public StrNode createStrNode(ISourcePosition position, ByteList buffer, int flags) {
        ...
        if ((flags & RubyYaccBeaverLexer.STR_FUNC_REGEXP) == 0 && bufferEncoding.isAsciiCompatible()) {
            ...
            if (codeRange == StringSupport.CR_7BIT) {
                // Do nothing like MRI
            } else if (getEncoding() == RubyYaccBeaverLexer.USASCII_ENCODING &&
                    bufferEncoding != RubyYaccBeaverLexer.UTF8_ENCODING) {
                codeRange = ParserSupport.associateEncoding(buffer, RubyYaccBeaverLexer.ASCII8BIT_ENCODING, codeRange);
            }
        }
    ...
    private int parseQuote(int c) throws IOException {
        ...
        case 'Q':
            ...
            return BeaverTokens.tSTRING_BEG;
        ...
        case 'W':
            ...
            src.unread(c);
            yaccValue = new Token("%"+c+begin, getPosition());
            return BeaverTokens.tWORDS_BEG;
    ...
    private void printToken(int token) {
        ...
        switch (token) {
            case BeaverTokens.yyErrorCode: System.err.print("yyErrorCode,"); break;
            case BeaverTokens.kCLASS: System.err.print("kClass,"); break;
            case BeaverTokens.kMODULE: System.err.print("kModule,"); break;
            case BeaverTokens.kDEF: System.err.print("kDEF,"); break;
            case BeaverTokens.kUNDEF: System.err.print("kUNDEF,"); break;
            case BeaverTokens.kBEGIN: System.err.print("kBEGIN,"); break;
            case BeaverTokens.kRESCUE: System.err.print("kRESCUE,"); break;
            case BeaverTokens.kENSURE: System.err.print("kENSURE,"); break;
            case BeaverTokens.kEND: System.err.print("kEND,"); break;
            case BeaverTokens.kIF: System.err.print("kIF,"); break;
            case BeaverTokens.kUNLESS: System.err.print("kUNLESS,"); break;
            case BeaverTokens.kTHEN: System.err.print("kTHEN,"); break;
            case BeaverTokens.kELSIF: System.err.print("kELSIF,"); break;
            case BeaverTokens.kELSE: System.err.print("kELSE,"); break;
            case BeaverTokens.kCASE: System.err.print("kCASE,"); break;
            case BeaverTokens.kWHEN: System.err.print("kWHEN,"); break;
            case BeaverTokens.kWHILE: System.err.print("kWHILE,"); break;
            case BeaverTokens.kUNTIL: System.err.print("kUNTIL,"); break;
            case BeaverTokens.kFOR: System.err.print("kFOR,"); break;
            case BeaverTokens.kBREAK: System.err.print("kBREAK,"); break;
            case BeaverTokens.kNEXT: System.err.print("kNEXT,"); break;
            case BeaverTokens.kREDO: System.err.print("kREDO,"); break;
            case BeaverTokens.kRETRY: System.err.print("kRETRY,"); break;
            case BeaverTokens.kIN: System.err.print("kIN,"); break;
            case BeaverTokens.kDO: System.err.print("kDO,"); break;
            case BeaverTokens.kDO_COND: System.err.print("kDO_COND,"); break;
            case BeaverTokens.kDO_BLOCK: System.err.print("kDO_BLOCK,"); break;
            case BeaverTokens.kRETURN: System.err.print("kRETURN,"); break;
            case BeaverTokens.kYIELD: System.err.print("kYIELD,"); break;
            case BeaverTokens.kSUPER: System.err.print("kSUPER,"); break;
            case BeaverTokens.kSELF: System.err.print("kSELF,"); break;
            case BeaverTokens.kNIL: System.err.print("kNIL,"); break;
            case BeaverTokens.kTRUE: System.err.print("kTRUE,"); break;
            case BeaverTokens.kFALSE: System.err.print("kFALSE,"); break;
            case BeaverTokens.kAND: System.err.print("kAND,"); break;
            case BeaverTokens.kOR: System.err.print("kOR,"); break;
            case BeaverTokens.kNOT: System.err.print("kNOT,"); break;
            case BeaverTokens.kIF_MOD: System.err.print("kIF_MOD,"); break;
            case BeaverTokens.kUNLESS_MOD: System.err.print("kUNLESS_MOD,"); break;
            case BeaverTokens.kWHILE_MOD: System.err.print("kWHILE_MOD,"); break;
            case BeaverTokens.kUNTIL_MOD: System.err.print("kUNTIL_MOD,"); break;
            case BeaverTokens.kRESCUE_MOD: System.err.print("kRESCUE_MOD,"); break;
            case BeaverTokens.kALIAS: System.err.print("kALIAS,"); break;
            case BeaverTokens.kDEFINED: System.err.print("kDEFINED,"); break;
            case BeaverTokens.klBEGIN: System.err.print("klBEGIN,"); break;
            case BeaverTokens.klEND: System.err.print("klEND,"); break;
            case BeaverTokens.k__LINE__: System.err.print("k__LINE__,"); break;
            case BeaverTokens.k__FILE__: System.err.print("k__FILE__,"); break;
            case BeaverTokens.k__ENCODING__: System.err.print("k__ENCODING__,"); break;
            case BeaverTokens.kDO_LAMBDA: System.err.print("kDO_LAMBDA,"); break;
            case BeaverTokens.tIDENTIFIER: System.err.print("tIDENTIFIER["+ value() + "],"); break;
            case BeaverTokens.tFID: System.err.print("tFID[" + value() + "],"); break;
            case BeaverTokens.tGVAR: System.err.print("tGVAR[" + value() + "],"); break;
            case BeaverTokens.tIVAR: System.err.print("tIVAR[" + value() +"],"); break;
            case BeaverTokens.tCONSTANT: System.err.print("tCONSTANT["+ value() +"],"); break;
            case BeaverTokens.tCVAR: System.err.print("tCVAR,"); break;
            case BeaverTokens.tINTEGER: System.err.print("tINTEGER,"); break;
            case BeaverTokens.tFLOAT: System.err.print("tFLOAT,"); break;
            case BeaverTokens.tSTRING_CONTENT: System.err.print("tSTRING_CONTENT[" + ((StrNode) value()).getValue().toString() + "],"); break;
            case BeaverTokens.tSTRING_BEG: System.err.print("tSTRING_BEG,"); break;
            case BeaverTokens.tSTRING_END: System.err.print("tSTRING_END,"); break;
            case BeaverTokens.tSTRING_DBEG: System.err.print("STRING_DBEG,"); break;
            case BeaverTokens.tSTRING_DVAR: System.err.print("tSTRING_DVAR,"); break;
            case BeaverTokens.tXSTRING_BEG: System.err.print("tXSTRING_BEG,"); break;
            case BeaverTokens.tREGEXP_BEG: System.err.print("tREGEXP_BEG,"); break;
            case BeaverTokens.tREGEXP_END: System.err.print("tREGEXP_END,"); break;
            case BeaverTokens.tWORDS_BEG: System.err.print("tWORDS_BEG,"); break;
            case BeaverTokens.tQWORDS_BEG: System.err.print("tQWORDS_BEG,"); break;
            case BeaverTokens.tBACK_REF: System.err.print("tBACK_REF,"); break;
            case BeaverTokens.tBACK_REF2: System.err.print("tBACK_REF2,"); break;
            case BeaverTokens.tNTH_REF: System.err.print("tNTH_REF,"); break;
            case BeaverTokens.tUPLUS: System.err.print("tUPLUS"); break;
            case BeaverTokens.tUMINUS: System.err.print("tUMINUS,"); break;
            case BeaverTokens.tPOW: System.err.print("tPOW,"); break;
            case BeaverTokens.tCMP: System.err.print("tCMP,"); break;
            case BeaverTokens.tEQ: System.err.print("tEQ,"); break;
            case BeaverTokens.tEQQ: System.err.print("tEQQ,"); break;
            case BeaverTokens.tNEQ: System.err.print("tNEQ,"); break;
            case BeaverTokens.tGEQ: System.err.print("tGEQ,"); break;
            case BeaverTokens.tLEQ: System.err.print("tLEQ,"); break;
            case BeaverTokens.tANDOP: System.err.print("tANDOP,"); break;
            case BeaverTokens.tOROP: System.err.print("tOROP,"); break;
            case BeaverTokens.tMATCH: System.err.print("tMATCH,"); break;
            case BeaverTokens.tNMATCH: System.err.print("tNMATCH,"); break;
            case BeaverTokens.tDOT: System.err.print("tDOT,"); break;
            case BeaverTokens.tDOT2: System.err.print("tDOT2,"); break;
            case BeaverTokens.tDOT3: System.err.print("tDOT3,"); break;
            case BeaverTokens.tAREF: System.err.print("tAREF,"); break;
            case BeaverTokens.tASET: System.err.print("tASET,"); break;
            case BeaverTokens.tLSHFT: System.err.print("tLSHFT,"); break;
            case BeaverTokens.tRSHFT: System.err.print("tRSHFT,"); break;
            case BeaverTokens.tCOLON2: System.err.print("tCOLON2,"); break;
            case BeaverTokens.tCOLON3: System.err.print("tCOLON3,"); break;
            case BeaverTokens.tOP_ASGN: System.err.print("tOP_ASGN,"); break;
            case BeaverTokens.tASSOC: System.err.print("tASSOC,"); break;
            case BeaverTokens.tLPAREN: System.err.print("tLPAREN,"); break;
            case BeaverTokens.tLPAREN2: System.err.print("tLPAREN2,"); break;
            case BeaverTokens.tLPAREN_ARG: System.err.print("tLPAREN_ARG,"); break;
            case BeaverTokens.tLBRACK: System.err.print("tLBRACK,"); break;
            case BeaverTokens.tRBRACK: System.err.print("tRBRACK,"); break;
            case BeaverTokens.tLBRACE: System.err.print("tLBRACE,"); break;
            case BeaverTokens.tLBRACE_ARG: System.err.print("tLBRACE_ARG,"); break;
            case BeaverTokens.tSTAR: System.err.print("tSTAR,"); break;
            case BeaverTokens.tSTAR2: System.err.print("tSTAR2,"); break;
            case BeaverTokens.tAMPER: System.err.print("tAMPER,"); break;
            case BeaverTokens.tAMPER2: System.err.print("tAMPER2,"); break;
            case BeaverTokens.tSYMBEG: System.err.print("tSYMBEG,"); break;
            case BeaverTokens.tTILDE: System.err.print("tTILDE,"); break;
            case BeaverTokens.tPERCENT: System.err.print("tPERCENT,"); break;
            case BeaverTokens.tDIVIDE: System.err.print("tDIVIDE,"); break;
            case BeaverTokens.tPLUS: System.err.print("tPLUS,"); break;
            case BeaverTokens.tMINUS: System.err.print("tMINUS,"); break;
            case BeaverTokens.tLT: System.err.print("tLT,"); break;
            case BeaverTokens.tGT: System.err.print("tGT,"); break;
            case BeaverTokens.tCARET: System.err.print("tCARET,"); break;
            case BeaverTokens.tBANG: System.err.print("tBANG,"); break;
            case BeaverTokens.tLCURLY: System.err.print("tTLCURLY,"); break;
            case BeaverTokens.tRCURLY: System.err.print("tRCURLY,"); break;
            case BeaverTokens.tPIPE: System.err.print("tTPIPE,"); break;
            case BeaverTokens.tLAMBDA: System.err.print("tLAMBDA,"); break;
            case BeaverTokens.tLAMBEG: System.err.print("tLAMBEG,"); break;
            case BeaverTokens.tRPAREN: System.err.print("tRPAREN,"); break;
            case BeaverTokens.tLABEL: System.err.print("tLABEL("+
    ...
    private int yylex() throws IOException {
        ...
        if (lex_strterm != null) {
            ...
            if (tok == BeaverTokens.tSTRING_END || tok == BeaverTokens.tREGEXP_END) {
                lex_strterm = null;
        ...
        loop: for(;;) {
            ...
            case '=':
                ...
                if (c == '=') {
                    ...
                    if (c == '=') {
                        yaccValue = new Token("===", getPosition());
                        return BeaverTokens.tEQQ;
                    }
                    src.unread(c);
                    yaccValue = new Token("==", getPosition());
                    return BeaverTokens.tEQ;
                }
                if (c == '~') {
                    yaccValue = new Token("=~", getPosition());
                    return BeaverTokens.tMATCH;
                } else if (c == '>') {
                    yaccValue = new Token("=>", getPosition());
                    return BeaverTokens.tASSOC;
                }
                src.unread(c);
                yaccValue = new Token("=", getPosition());
                return tASSIGNMENT;
    ...
    private int identifierToken(LexState last_state, int result, String value) {
        ...
        if (result == BeaverTokens.tIDENTIFIER && last_state != LexState.EXPR_DOT &&
    ...
    private int ampersand(boolean spaceSeen) throws IOException {
        ...
        case '&':
            ...
            if ((c = src.read()) == '=') {
                yaccValue = new Token("&&", getPosition());
                setState(LexState.EXPR_BEG);
                return BeaverTokens.tOP_ASGN;
            }
            src.unread(c);
            yaccValue = new Token("&&", getPosition());
            return BeaverTokens.tANDOP;
        case '=':
            yaccValue = new Token("&", getPosition());
            setState(LexState.EXPR_BEG);
            return BeaverTokens.tOP_ASGN;
        ...
        if (isARG() && spaceSeen && !Character.isWhitespace(c)) {
            ...
            c = BeaverTokens.tAMPER;
        } else if (isBEG()) {
            c = BeaverTokens.tAMPER;
        } else {
            c = BeaverTokens.tAMPER2;
        }
    ...
    private int at() throws IOException {
        ...
        if (c == '@') {
            tokenBuffer.append('@');
            c = src.read();
            result = BeaverTokens.tCVAR;
        } else {
            result = BeaverTokens.tIVAR;                    
        }
    ...
    private int backtick(boolean commandState) throws IOException {
        ...
        case EXPR_FNAME:
            ...
            return BeaverTokens.tBACK_REF2;
        case EXPR_DOT:
    ...
    private int bang() throws IOException {
        ...
        case '=':
            ...
            return BeaverTokens.tNEQ;
        case '~':
            yaccValue = new Token("!~",getPosition());
            
            return BeaverTokens.tNMATCH;
    ...
    private int colon(boolean spaceSeen) throws IOException {
        ...
        if (c == ':') {
            if (isBEG() || lex_state == LexState.EXPR_CLASS || (isARG() && spaceSeen)) {
                setState(LexState.EXPR_BEG);
                yaccValue = new Token("::", getPosition());
                return BeaverTokens.tCOLON3;
            }
            setState(LexState.EXPR_DOT);
            yaccValue = new Token(":",getPosition());
            return BeaverTokens.tCOLON2;
        }
    ...
    private int doKeyword(LexState state) {
        ...
        if (!isOneEight && leftParenBegin > 0 && leftParenBegin == parenNest) {
            leftParenBegin = 0;
            parenNest--;
            return BeaverTokens.kDO_LAMBDA;
        }

        if (conditionState.isInState()) return BeaverTokens.kDO_COND;

        if (state != LexState.EXPR_CMDARG && cmdArgumentState.isInState()) {
            return BeaverTokens.kDO_BLOCK;
        }
        if (state == LexState.EXPR_ENDARG || (!isOneEight && state == LexState.EXPR_BEG)) {
            return BeaverTokens.kDO_BLOCK;
        }
        return BeaverTokens.kDO;
    }
    ...
    private int dollar() throws IOException {
        ...
        case '_':       /* $_: last read line string */
            ...
            if (isIdentifierChar(c)) {
                ...
                return identifierToken(last_state, BeaverTokens.tGVAR, tokenBuffer.toString().intern());
            }
            src.unread(c);
            c = '_';
        ...
        case '\"':      /* $": already loaded files */
            yaccValue = new Token("$" + (char) c, BeaverTokens.tGVAR, getPosition());
            return BeaverTokens.tGVAR;
        ...
        case '-':
            ...
            yaccValue = new Token(tokenBuffer.toString(), BeaverTokens.tGVAR, getPosition());
        ...
        case '7': case '8': case '9':
            ...
            return BeaverTokens.tNTH_REF;
        case '0':
            setState(LexState.EXPR_END);

            return identifierToken(last_state, BeaverTokens.tGVAR, ("$" + (char) c).intern());
        default:
            if (!isIdentifierChar(c)) {
                src.unread(c);
                yaccValue = new Token("$", getPosition());
    ...
    private int dot() throws IOException {
        ...
        if ((c = src.read()) == '.') {
            if ((c = src.read()) == '.') {
                yaccValue = new Token("...", getPosition());
                return BeaverTokens.tDOT3;
            }
            src.unread(c);
            yaccValue = new Token("..", getPosition());
            return BeaverTokens.tDOT2;
        }
    ...
    private int greaterThan() throws IOException {
        ...
        case '>':
            ...
            yaccValue = new Token(">>", getPosition());
            return BeaverTokens.tRSHFT;
        default:
            src.unread(c);
            yaccValue = new Token(">", getPosition());
            return BeaverTokens.tGT;
        }
    }
        ...
        if (lastBangOrPredicate) {
            ...
            if (lex_state == LexState.EXPR_FNAME) {
                if ((c = src.read()) == '=') { 
                    ...
                    if (c2 != '~' && c2 != '>' &&
                            (c2 != '=' || src.peek('>'))) {
                        result = BeaverTokens.tIDENTIFIER;
                        tokenBuffer.append((char) c);
                        src.unread(c2);
                    } else { 
                        src.unread(c2);
        ...
        if (lex_state != LexState.EXPR_DOT) {
            ...
            if (keyword != null && (keyword != Keyword.__ENCODING__ || !isOneEight)) {
                ...
                if (state == LexState.EXPR_FNAME) {
                    ...
                    yaccValue = new Token(tempVal, getPosition());
                    if (keyword.id0 == BeaverTokens.kDO) return doKeyword(state);
                }
        ...
        if (lex_state == LexState.EXPR_FNAME || lex_state == LexState.EXPR_DOT) {
            ...
            if ((c = src.read()) == ']') {
                if (src.peek('=')) {
                    c = src.read();
                    yaccValue = new Token("[]=", getPosition());
                    return BeaverTokens.tASET;
                }
                yaccValue = new Token("[]", getPosition());
                return BeaverTokens.tAREF;
            }
            src.unread(c);
            yaccValue = new Token("[", getPosition());
            return BeaverTokens.tLSQ;
        } else if (isBEG() || (isARG() && spaceSeen)) {
            c = BeaverTokens.tLBRACK;
        }
    ...
    private int leftCurly() {
        ...
        yaccValue = new Token("{", getPosition());
        if (!isOneEight && c != BeaverTokens.tLBRACE) commandStart = true;
        return c;
    }
    ...
    private int lessThan(boolean spaceSeen) throws IOException {
        ...
        case '=':
            if ((c = src.read()) == '>') {
                yaccValue = new Token("<=>", getPosition());
                return BeaverTokens.tCMP;
            }
            src.unread(c);
            yaccValue = new Token("<=", getPosition());
            return BeaverTokens.tLEQ;
        case '<':
            if ((c = src.read()) == '=') {
                setState(LexState.EXPR_BEG);
                yaccValue = new Token("<<", getPosition());
            ...
            src.unread(c);
            yaccValue = new Token("<<", getPosition());
            return BeaverTokens.tLSHFT;
        default:
            yaccValue = new Token("<", getPosition());
            src.unread(c);
            return BeaverTokens.tLT;
        }
    }
    ...
    private int minus(boolean spaceSeen) throws IOException {
        ...
        if (lex_state == LexState.EXPR_FNAME || lex_state == LexState.EXPR_DOT) {
            ...
            if (c == '@') {
                yaccValue = new Token("-@", getPosition());
                return BeaverTokens.tUMINUS;
            }
            src.unread(c);
            yaccValue = new Token("-", getPosition());
            return BeaverTokens.tMINUS;
        }
        if (c == '=') {
            setState(LexState.EXPR_BEG);
            yaccValue = new Token("-", getPosition());
        ...
        if (isBEG() || (isARG() && spaceSeen && !Character.isWhitespace(c))) {
            ...
            yaccValue = new Token("-", getPosition());
            if (Character.isDigit(c)) {
                return BeaverTokens.tUMINUS_NUM;
            }
            return BeaverTokens.tUMINUS;
        }
        setState(LexState.EXPR_BEG);
    ...
    private int plus(boolean spaceSeen) throws IOException {
        ...
        if (lex_state == LexState.EXPR_FNAME || lex_state == LexState.EXPR_DOT) {
            ...
            if (c == '@') {
                yaccValue = new Token("+@", getPosition());
                return BeaverTokens.tUPLUS;
            }
            src.unread(c);
            yaccValue = new Token("+", getPosition());
            return BeaverTokens.tPLUS;
        }
    ...
    private int star(boolean spaceSeen) throws IOException {
        ...
        default:
            ...
            if (isARG() && spaceSeen && !Character.isWhitespace(c)) {
                ...
                c = BeaverTokens.tSTAR;
            } else if (isBEG()) {
                c = BeaverTokens.tSTAR;
            } else {
                c = BeaverTokens.tSTAR2;
            }
            yaccValue = new Token("*", getPosition());
        }
